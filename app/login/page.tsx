...
export const metadata: Metadata = {
  title: "Login - DocuGuard",
  description: "Login to access secure documentation",
};
          ...
          <TabsContent value="signin">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Sign in to your account to access protected content
                </CardDescription>
              </CardHeader>
          ...
          <TabsContent value="signup">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Create a new account to access protected content
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-2">
